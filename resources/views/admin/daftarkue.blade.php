...
<body class="bg-steel">
    ...
    <div class="page-content">
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                ...
                <div class="cell auto-size padding20 bg-white" id="cell-content">
                    <h1 class="text-light"><a href="{{ ('mulai') }}" class="nav-button transform"><span></span></a> DATA KUE
                    ...
                    <table class="dataTable border bordered" data-role="datatable" data-auto-width="false">
                        ...
                        <tr>
                            ...
                            <td class="sortable-column">Nama Kue</td>
      ...
      ?>
                        <tr>
                  <td><?php echo $i;?></td>
                  <td><?php echo $key['nama_kue'];?></td>
                  <td><?php echo $key['harga'];?></td>
                  <td><?php echo strtoupper($key['status']);?></td>
                  
                 <td>           <a href="{{ ('daftarkuea/editj/'.$key['id']) }}" class="btn biru">
                                <font color="white">Ubah</fkont></a>
                                <a href="{{ ('daftarkuea/delete/'.$key['id']) }}" class="btn biru" 
