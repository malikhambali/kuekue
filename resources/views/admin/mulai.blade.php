...
<body style="overflow-y: hidden;">
    ...
    <div class="tile-area tile-area-scheme-dark fg-white" style="height: 100%; max-height: 100% !important;">
        ...
        <div class="tile-group double">
            <span class="tile-group-title">Pemesanan</span>
            ...
            <div class="tile-container">
                ...
                <a href="{{ url('adminh') }}" class="tile-wide bg-black fg-indigo" data-role="tile">
                    ...
                    <span class="tile-label">Data Pemesanan</span>
                </a>
                <div class="tile-wide" data-role="tile" data-effect="slideLeft">
                    <div class="tile-content">
                        <a class="live-slide"><img src="../metro/images/1.jpg" data-role="fitImage" data-format="fill"></a>
                        <a class="live-slide"><img src="../metro/images/2.jpg" data-role="fitImage" data-format="fill"></a>
                        <a class="live-slide"><img src="../metro/images/3.jpg" data-role="fitImage" data-format="fill"></a>
        ...
        <div class="tile-group double">
            ...
            <div class="tile-container">
                ...
                <a href="{{ ('input') }}" class="tile bg-indigo fg-black" data-role="tile">
                    ...
                    <span class="tile-label">Tambah Admin</span>
                </a>
